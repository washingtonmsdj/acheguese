...
BEGIN
  ...
  INSERT INTO pizza_sizes (id, business_id, name, base_price, max_flavors, sort_order, is_available)
  VALUES
  ...
  -- 13) Sabores de pizza
  INSERT INTO pizza_flavors (id, business_id, name, description, base_price, ingredients, allergens, is_available)
  VALUES
    ('f2222222-2222-2222-2222-222222222301', v_business_id, 'Margherita', 'Molho de tomate, mussarela e manjericão', 45.00, ARRAY['tomate', 'mussarela', 'manjericao'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222302', v_business_id, 'Calabresa', 'Calabresa artesanal, cebola e azeitonas', 48.00, ARRAY['calabresa', 'cebola', 'azeitona'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222303', v_business_id, 'Pepperoni', 'Pepperoni importado, mussarela e orégano', 52.00, ARRAY['pepperoni', 'mussarela', 'oregano'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222304', v_business_id, 'Portuguesa', 'Presunto, ovos, cebola, azeitonas e ervilha', 49.00, ARRAY['presunto', 'ovo', 'cebola', 'azeitona', 'ervilha'], ARRAY['ovo'], true),
    ('f2222222-2222-2222-2222-222222222305', v_business_id, 'Mussarela', 'Mussarela especial, molho de tomate e orégano', 42.00, ARRAY['mussarela', 'tomate', 'oregano'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222306', v_business_id, 'Frango com Catupiry', 'Frango desfiado, catupiry e milho', 50.00, ARRAY['frango', 'catupiry', 'milho'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222307', v_business_id, 'Quattro Formaggi', 'Gorgonzola, parmesão, mussarela e provolone', 58.00, ARRAY['gorgonzola', 'parmesao', 'mussarela', 'provolone'], ARRAY['lactose'], true),
    ('f2222222-2222-2222-2222-222222222308', v_business_id, 'Bacon', 'Bacon crocante, mussarela e cebola', 51.00, ARRAY['bacon', 'mussarela', 'cebola'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222309', v_business_id, 'Atum', 'Atum sólido, cebola e azeitonas', 53.00, ARRAY['atum', 'cebola', 'azeitona'], ARRAY['peixe'], true),
    ('f2222222-2222-2222-2222-222222222310', v_business_id, 'Palmito', 'Palmito, mussarela e orégano', 47.00, ARRAY['palmito', 'mussarela', 'oregano'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222311', v_business_id, 'Camarão', 'Camarões, cream cheese e rúcula', 68.00, ARRAY['camarao', 'cream_cheese', 'rucula'], ARRAY['crustaceos'], true),
    ('f2222222-2222-2222-2222-222222222312', v_business_id, 'Presunto Parma', 'Presunto parma importado e rúcula', 62.00, ARRAY['presunto_parma', 'rucula'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222313', v_business_id, 'Brócolis', 'Brócolis, bacon crocante e mussarela', 46.00, ARRAY['brocolis', 'bacon', 'mussarela'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222314', v_business_id, 'Lombinho', 'Lombinho defumado, mussarela e cebola', 52.00, ARRAY['lombinho', 'mussarela', 'cebola'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222315', v_business_id, 'Vegetariana', 'Berinjela, abobrinha, pimentão e cogumelos', 45.00, ARRAY['berinjela', 'abobrinha', 'pimentao', 'cogumelos'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222316', v_business_id, 'Chocolate com Morango', 'Chocolate ao leite e morangos frescos', 42.00, ARRAY['chocolate', 'morango'], ARRAY['lactose'], true),
    ('f2222222-2222-2222-2222-222222222317', v_business_id, 'Banana com Canela', 'Banana caramelizada e canela', 38.00, ARRAY['banana', 'canela'], ARRAY[], true),
    ('f2222222-2222-2222-2222-222222222318', v_business_id, 'Romeu e Julieta', 'Goiabada e queijo minas', 35.00, ARRAY['goiabada', 'queijo_minas'], ARRAY['lactose'], true)
  ON CONFLICT (id) DO UPDATE
  SET
    business_id = EXCLUDED.business_id,
    name = EXCLUDED.name,
  ...
  -- 14) Bordas recheadas
  INSERT INTO pizza_edges (id, business_id, name, description, price, is_available)
  VALUES
    ('e2222222-2222-2222-2222-222222222301', v_business_id, 'Catupiry', 'Borda recheada com catupiry cremoso', 12.00, true),
    ('e2222222-2222-2222-2222-222222222302', v_business_id, 'Cheddar', 'Borda recheada com cheddar inglês', 12.00, true),
    ('e2222222-2222-2222-2222-222222222303', v_business_id, 'Mussarela', 'Borda recheada com mussarela especial', 10.00, true),
    ('e2222222-2222-2222-2222-222222222304', v_business_id, 'Nutella', 'Borda doce recheada com Nutella', 15.00, true),
    ('e2222222-2222-2222-2222-222222222305', v_business_id, 'Chocolate', 'Borda doce recheada com chocolate meio amargo', 14.00, true)
  ON CONFLICT (id) DO UPDATE
  SET
    business_id = EXCLUDED.business_id,
    name = EXCLUDED.name,
  ...
  -- 15) Massas
  INSERT INTO pizza_doughs (id, business_id, name, description, price_adjustment, is_available)
  VALUES
    ('g2222222-2222-2222-2222-222222222301', v_business_id, 'Tradicional', 'Massa fermentada por 72h, fina e crocante', 0.00, true),
    ('g2222222-2222-2222-2222-222222222302', v_business_id, 'Fina (Napolitana)', 'Massa extra fina estilo Napoli', 3.00, true),
    ('g2222222-2222-2222-2222-222222222303', v_business_id, 'Pan', 'Massa mais grossa, estilo americano', 5.00, true),
    ('g2222222-2222-2222-2222-222222222304', v_business_id, 'Integral', 'Massa integral com farelo de aveia', 4.00, true),
    ('g2222222-2222-2222-2222-222222222305', v_business_id, 'Sem Glúten', 'Massa sem glúten especial', 8.00, true)
  ON CONFLICT (id) DO UPDATE
  SET
    business_id = EXCLUDED.business_id,
    name = EXCLUDED.name,
