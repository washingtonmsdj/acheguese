-- ============================================================================
-- FIX: create_profile_with_extension - Corrigir auth.uid()
-- ============================================================================
-- PROBLEMA: RPC não estava atribuindo v_current_user_id corretamente
-- SOLUÇÃO: Adicionar validação de autenticação e atribuição explícita
-- ============================================================================
...
COMMENT ON FUNCTION create_profile_with_extension IS 'Multi-perfil: criar perfil com extensão obrigatória para business/professional/driver (FIXED: auth.uid())';
