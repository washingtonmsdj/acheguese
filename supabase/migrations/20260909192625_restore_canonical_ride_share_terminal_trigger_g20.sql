-- G20B: restore the pre-existing terminal ride-share trigger as the single lifecycle owner.
--
-- G20 briefly duplicated terminal share closure inside the ride transition.
-- The canonical trigger private.revoke_terminal_ride_shares already owns this
-- privacy boundary and revokes shares for all configured terminal states.
