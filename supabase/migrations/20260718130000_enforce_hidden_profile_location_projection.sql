-- public_location_visibility is deny-by-default. A hidden profile must not
-- expose names, state codes, or identifiers derived from its residence.
...
COMMENT ON VIEW public.public_profiles IS
  'Canonical PII-free public profile projection. Hidden profiles expose no residence-derived territory; city_only and district expose only the consented level.';
