-- Final public snapshot RPCs without public URL redirect compatibility.
-- Canonical route mismatch returns NULL; old URL history tables are removed below.
-- HOTFIX (2026-04-25):
...
-- Remove public URL redirect/history artifacts from the final schema.
DROP TABLE IF EXISTS classified_url_history CASCADE;
DROP TABLE IF EXISTS business_slug_history CASCADE;
