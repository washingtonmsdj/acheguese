-- Canonicalize public gastronomy detail snapshots to the business public URL.
--
-- Product decision:
--   - Community/listing: /:communitySlug/gastronomia
--   - Business/restaurant detail: /:communitySlug/:slug when an alias exists
--   - Technical fallback: /empresas/:uf/:cidade/:bairro/:slug
--   - Legacy gastronomy detail routes redirect to the business public URL
--
-- The v_gastronomy_url variable name is retained inside the RPC body only for
-- response-contract compatibility; its value now points to the canonical
-- business public URL.
-- ============================================================================
