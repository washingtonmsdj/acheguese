-- G19B: terminal release must respect the canonical availability invariant.
--
-- A driver can become available automatically only when online and carrying
-- fresh coordinates. Otherwise terminal transition clears busy ownership but
-- leaves the driver online/warming-up until location is refreshed.
