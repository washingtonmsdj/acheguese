...
export const MeusVinculosConceptMockPage = lazy(
  () => import("@/app/pages/MeusVinculosConceptMockPage"),
);
export const PublicacaoDetalheConceptMockPage = lazy(
  () => import("@/app/pages/PublicacaoDetalheConceptMockPage"),
);
export const ModeracaoComunidadeConceptMockPage = lazy(
  () => import("@/app/pages/ModeracaoComunidadeConceptMockPage"),
);
...
export const AgendaEventosConceptMockPage = lazy(
  () => import("@/app/pages/AgendaEventosConceptMockPage"),
);
export const OrganizarEventosConceptMockPage = lazy(
  () => import("@/app/pages/OrganizarEventosConceptMockPage"),
);
export const InscricaoCheckinConceptMockPage = lazy(
  () => import("@/app/pages/InscricaoCheckinConceptMockPage"),
);
