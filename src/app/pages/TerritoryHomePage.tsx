      ...
      <main className="mx-auto max-w-2xl px-4 pt-3">
        ...
        <section aria-labelledby="quick-actions-title" className="mt-6">
          ...
          <ul className="grid grid-cols-4 gap-3">
            {[
              { id: "qa1", label: "Buscar", icon: Search, category: "business" as ContentCategoryKey, href: LAUNCH_URLS.search },
              { id: "qa2", label: "Perto de mim", icon: MapPin, category: "discussion" as ContentCategoryKey, href: LAUNCH_URLS.map ?? LAUNCH_URLS.search },
              { id: "qa3", label: "Comer agora", icon: UtensilsCrossed, category: "gastronomy" as ContentCategoryKey, href: LAUNCH_URLS.gastronomy },
              { id: "qa4", label: "Mobilidade", icon: Car, category: "mobility" as ContentCategoryKey, href: LAUNCH_URLS.map ?? LAUNCH_URLS.search },
            ].map((action) => {
              ...
              return (
                <li key={action.id}>
                  ...
                  >
                    <span className={`flex h-16 w-16 items-center justify-center rounded-2xl shadow-sm ${tokens.chip}`}>
