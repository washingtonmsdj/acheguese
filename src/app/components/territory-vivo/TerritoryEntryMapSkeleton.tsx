  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-90 motion-safe:animate-pulse motion-reduce:animate-none">
        <span className="absolute left-[7%] top-[10%] h-[18%] w-[28%] rounded-2xl bg-territory-surface/50 lg:left-[8%] lg:top-[9%] lg:h-[16%] lg:w-[24%] lg:rounded-3xl" />
        <span className="absolute right-[8%] top-[16%] h-[22%] w-[34%] rounded-2xl bg-territory-surface/40 lg:right-[9%] lg:top-[12%] lg:h-[24%] lg:w-[30%] lg:rounded-3xl" />
        ...
        <span className="absolute bottom-[13%] right-[9%] hidden h-[18%] w-[24%] rounded-3xl bg-territory-surface/40 lg:block" />
      ...
      <div className="absolute inset-0 overflow-hidden opacity-60" aria-hidden="true">
        ...
        <span className="absolute left-[54%] top-[-14%] h-[78%] w-2 rotate-[18deg] rounded-full bg-territory-surface/60 lg:w-3" />
        <span className="absolute left-[17%] top-[8%] hidden h-[92%] w-2 -rotate-[24deg] rounded-full bg-territory-surface/50 lg:block lg:w-3" />
      </div>
      ...
      <div className="absolute right-6 top-6 hidden items-center gap-2 rounded-full border border-territory-border bg-territory-surface/80 px-3 py-2 text-xs font-medium text-territory-muted-strong shadow-sm backdrop-blur-sm lg:flex">
        <span className="h-2 w-2 rounded-full bg-territory-brand/50" />
        Preparando visualizacao territorial
      </div>

      <div className="absolute inset-x-3 bottom-3 rounded-2xl border border-territory-border bg-territory-surface/95 px-3.5 py-3 shadow-territory-highlight backdrop-blur-sm sm:inset-x-4 sm:bottom-4 sm:px-4 lg:inset-x-auto lg:bottom-6 lg:left-6 lg:w-[30rem] lg:max-w-[calc(100%_-_3rem)] lg:rounded-3xl lg:px-5 lg:py-4">
