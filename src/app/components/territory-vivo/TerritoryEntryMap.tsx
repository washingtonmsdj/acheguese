...
function EntryMapPlaceholder({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 bg-[linear-gradient(90deg,hsl(var(--territory-border)/0.2)_1px,transparent_1px),linear-gradient(hsl(var(--territory-border)/0.2)_1px,transparent_1px),radial-gradient(circle_at_62%_36%,hsl(var(--territory-brand)/0.14),transparent_30%),linear-gradient(145deg,hsl(var(--territory-raised)),hsl(var(--territory-surface)))] bg-[size:72px_72px,72px_72px,100%_100%,100%_100%]"
        aria-hidden="true"
      />

      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute left-[14%] top-[18%] h-12 w-28 animate-pulse rounded-2xl bg-territory-surface/55" />
        <div className="absolute right-[12%] top-[28%] h-16 w-36 animate-pulse rounded-2xl bg-territory-surface/45 [animation-delay:120ms]" />
        <div className="absolute bottom-[22%] left-[34%] h-14 w-32 animate-pulse rounded-2xl bg-territory-surface/50 [animation-delay:240ms]" />
      </div>

      <div className="pointer-events-none absolute inset-x-4 bottom-4 rounded-2xl border border-territory-border bg-territory-surface/92 px-4 py-3 shadow-territory-highlight backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="absolute h-7 w-7 animate-ping rounded-full border border-territory-brand/35" />
          </span>
