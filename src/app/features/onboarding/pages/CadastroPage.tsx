          ...
          <React.Fragment key={step.id}>
            ...
            <button
              ...
              className={cn(
                ...
                isDone && "border-primary/25 bg-primary/6 text-primary hover:bg-primary/10",
                !isActive && !isDone && "border-border/70 bg-card/60 text-muted-foreground",
              )}
            >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                  ...
                  <div className="space-y-4 sm:space-y-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className={cn("h-10 sm:h-11", errors.name && "border-destructive")}
                        autoComplete="name"
                      />
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(event) =>
                            updateField(
                              "username",
                              event.target.value.replace(/[^a-z0-9_]/g, "").toLowerCase(),
                            )
                          }
                          onKeyDown={(event) => setCapsLock(event.getModifierState("CapsLock"))}
                          onKeyUp={(event) => setCapsLock(event.getModifierState("CapsLock"))}
                          className={cn("h-10 pl-8 sm:h-11", errors.username && "border-destructive")}
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className={cn("h-10 sm:h-11", errors.email && "border-destructive")}
                        autoComplete="email"
                      />
                        ...
                        <div className="space-y-1 rounded-2xl border border-border/60 bg-secondary/35 p-3">
                          {passwordRequirements.map((requirement) => (
                            <div
                              ...
                              className={cn(
                                "text-xs",
                                requirement.satisfied ? "text-emerald-400" : "text-muted-foreground",
                              )}
                            >
                ...
                {stepId === "location" ? (
                  <div className="space-y-4 sm:space-y-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        <SelectTrigger className={cn("h-10 sm:h-11", errors.stateId && "border-destructive")}>
                      ...
                      {errors.stateId ? (
                        <p className="text-xs text-destructive">{errors.stateId}</p>
                      ) : null}
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        <SelectTrigger className={cn("h-10 sm:h-11", errors.cityId && "border-destructive")}>
                          <SelectValue
                            placeholder={
                              !formData.stateId
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Select
                        ...
                        onValueChange={(id) => {
                          const found = neighborhoods.find((neighborhood) => neighborhood.id === id);
                          if (found) selectNeighborhood(found.id, found.name);
                        }}
                        disabled={!formData.cityId || loadingNeighborhoods}
                      >
                        <SelectTrigger
                          className={cn("h-10 sm:h-11", errors.neighborhoodId && "border-destructive")}
                        >
                          <SelectValue
                            placeholder={
                              !formData.cityId
                      ...
                      {errors.neighborhoodId ? (
                        <p className="text-xs text-destructive">{errors.neighborhoodId}</p>
                      ) : null}
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className={cn("h-10 sm:h-11", errors.street && "border-destructive")}
                      />
                ...
                {stepId === "confirm" ? (
                  <div className="space-y-4 sm:space-y-5">
                    ...
                    <div className="overflow-hidden rounded-2xl border border-border/70 bg-secondary/30">
                      ...
                      <div className="flex items-start gap-3 border-b border-border/60 p-4">
                        <span className="mt-0.5 shrink-0 text-sm text-muted-foreground">Mail</span>
                        <div className="min-w-0">
                ...
                <div className="mt-6 flex items-center justify-between border-t border-border/70 pt-5">
                  {currentStep > 0 ? (
                    <Button type="button" variant="ghost" onClick={handleBack} className="gap-1.5 px-0 sm:px-3">
