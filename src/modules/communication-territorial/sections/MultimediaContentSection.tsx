...
export function MultimediaContentSection() {
  const videos = [
    { id: 1, title: "Documentário: História do Nordeste de Amaralina", channel: "TV Comunitária", views: "2.3k", duration: "15:42", thumbnail: "https://images.unsplash.com/photo-1485846234645-a62644f84728?w=400&h=250&fit=crop" },
    { id: 2, title: "Entrevista com artista local", channel: "Rádio Comunitária", views: "1.8k", duration: "22:15", thumbnail: "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=400&h=250&fit=crop" },
    ...
    { id: 4, title: "Tutorial: Como participar das ações comunitárias", channel: "Coletivo Cultural", views: "956", duration: "8:45", thumbnail: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=400&h=250&fit=crop" },
  ];
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="mb-1.5 sm:mb-2 flex items-center gap-2">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground">Conteúdo Multimídia</h2>
          </div>
          <p className="text-sm sm:text-base text-muted-foreground">Vídeos e podcasts produzidos pela comunidade</p>
        </div>
        <Link to="/comunicacao/videos" className="text-xs sm:text-sm font-medium text-primary hover:opacity-80">Ver todos</Link>
      </div>
