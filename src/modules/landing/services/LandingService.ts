 ...
 * 
 * @example
 * import { getCountryData, getActiveStates, getPlatformStats } from '@/modules/landing/services/LandingService';
 * import type { CountryData, StateData, PlatformStats } from '@/modules/landing/services/LandingService';
 */
