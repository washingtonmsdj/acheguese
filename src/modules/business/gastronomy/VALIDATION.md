...
### Barrel Exports
- [x] `src/modules/business/gastronomy/index.ts` - export principal
- [x] `src/modules/business/gastronomy/hooks/index.ts` - hooks
- [x] `src/modules/business/gastronomy/services/index.ts` - services
- [x] `src/modules/business/gastronomy/types/index.ts` - types
- [x] `src/modules/business/gastronomy/components/index.ts` - components
- [x] `src/modules/business/gastronomy/utils/index.ts` - utils
...
1. Criar arquivo em `src/modules/business/gastronomy/hooks/`
2. Exportar em `src/modules/business/gastronomy/hooks/index.ts`
3. Documentar em `src/modules/business/gastronomy/hooks/README.md`
4. Seguir padrão: apenas estado, delegar lógica aos services

### Ao Adicionar Novos Services
1. Criar arquivo em `src/modules/business/gastronomy/services/`
2. Exportar em `src/modules/business/gastronomy/services/index.ts`
...
2. Exportar em `src/modules/business/gastronomy/types/index.ts`
