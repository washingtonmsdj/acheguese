...
export const sushiNicheConfig: GastronomyNicheConfig = createNichePreset({
  ...
  missingCapabilities: ['sushi_piece_count','sushi_combinado_builder','sushi_sashimi_weight'],
  defaultConfig: {
    ...
    suggestedCategories: ['Sushis','Sashimis','Combinados','Hot Rolls','Temakis','Entradas'],
    suggestedItems: ['Salmão','Atum','Peixe Branco','Hot Roll','Temaki'],
    nicheSpecific: {
  ...
  adminSections: [
    ...
    'operational_hours','reservations','order_management','analytics','sushi_builder','sushi_pieces',
  ],
  validationRules: { minPrice: 8, maxPrice: 300, maxVariantsPerItem: 6, maxAddonsPerItem: 10, requiresPhoto: true },
  displayOrder: 50,
