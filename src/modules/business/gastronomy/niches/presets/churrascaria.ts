...
export const churrascariaNicheConfig: GastronomyNicheConfig = createNichePreset({
  ...
  missingCapabilities: ['meat_weight_pricing','meat_cut_selection','meat_point_selection'],
  defaultConfig: {
    ...
    suggestedCategories: ['Carnes Bovinas','Carnes Suínas','Frangos','Linguiças','Porções','Acompanhamentos'],
    suggestedItems: ['Picanha','Costela','Linguiça','Frango','Arroz'],
    nicheSpecific: {
      weightUnit: 'kg',
      pricePerKg: true,
      defaultPortionSize: 0.5,
      meatPoints: ['mal_passado','ao_ponto','bem_passado'],
      cuts: ['picanha','costela','maminha','fraldinha','linguica','asa','coxa','peito'],
    },
  },
  adminSections: ['basic_menu','variants','addons','combos','promotions','delivery_areas','operational_hours','reservations','order_management','analytics','meat_cuts','meat_pricing'],
  validationRules: { minPrice: 30, maxPrice: 500, maxVariantsPerItem: 4, maxAddonsPerItem: 15 },
  displayOrder: 65,
