...
export const cafesNicheConfig: GastronomyNicheConfig = createNichePreset({
  ...
  defaultConfig: {
    ...
    suggestedCategories: ['Cafés','Capuccinos','Bebidas Quentes','Bebidas Geladas','Lanches','Doces'],
    suggestedItems: ['Café Expresso','Cappuccino','Latte','Pão de Queijo','Croissant'],
  },
  ...
  validationRules: { minPrice: 3, maxPrice: 50, maxVariantsPerItem: 4, maxAddonsPerItem: 8 },
  displayOrder: 45,
