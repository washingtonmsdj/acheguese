...
import { DeliveryService, DeliveryRequestStatus } from '@/modules/business/gastronomy/services/DeliveryService';
...
export function useAddTrackingPoint() {
  ...
  return useMutation({
    ...
    onError: (error: Error) => {
      logger.error('Erro ao adicionar ponto de rastreamento:', error.message);
    },
  });
}
