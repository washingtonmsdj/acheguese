/**
 * Empresa Sections - Barrel Export
 * 
 * Sections modulares para EmpresaDetailLandingPage
 */

export { EmpresaHeroSection } from './EmpresaHeroSection';
export { EmpresaCTAsSection } from './EmpresaCTAsSection';
