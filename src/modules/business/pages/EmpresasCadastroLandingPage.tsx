...
const benefits = [
  "Perfil público para ser encontrado no bairro",
  "Central para atualizar dados e atendimento",
  "Endereço, contatos e informações em um só lugar",
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Cadastre sua empresa no Achegue-se e mantenha suas informações organizadas na Central."
        />
      </Helmet>
        ...
        <section className="mx-auto grid min-h-screen w-full max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8">
          <div className="space-y-7">
            <div className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-background/75 px-3 py-1 text-xs font-semibold text-muted-foreground backdrop-blur">
              ...
              Para quem empreende no bairro
            </div>

            <div className="space-y-4">
              <h1 className="max-w-3xl text-4xl font-black tracking-tight text-foreground sm:text-5xl lg:text-6xl">
                Coloque sua empresa no Achegue-se e mantenha tudo organizado.
              </h1>
              <p className="max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                Crie sua presença no bairro para que moradores encontrem sua empresa e use a Central para manter endereço, contatos e informações sempre atualizados.
              </p>
            </div>
            ...
            <CardContent className="space-y-5 p-6 sm:p-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-foreground">
                  Do cadastro à presença no bairro
                </h2>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Moradores encontram sua empresa no Achegue-se. Você cuida das informações e atualizações pela Central.
                </p>
              </div>
              ...
              <div className="space-y-3">
                {benefits.map((item) => (
                  <div
                    key={item}
                    className="flex items-start gap-3 rounded-2xl bg-muted/45 p-3 text-sm"
                  >
              ...
              <div className="grid gap-3 pt-2 sm:grid-cols-2">
                <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
                  ...
                  <p className="mt-3 text-sm font-semibold">Para moradores</p>
                ...
                <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
                  ...
                  <p className="mt-3 text-sm font-semibold">Para você</p>
                  <p className="text-xs text-muted-foreground">
                    Central da empresa
                  </p>
                </div>
