...
const benefits = [
  "Perfil publico para descoberta local",
  "Painel operacional na Central",
  "Gestao de dados, verticais e planos em um so lugar",
];
        ...
        <section className="mx-auto grid min-h-screen w-full max-w-6xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8">
          <div className="space-y-7">
            ...
            <div className="space-y-4">
              <h1 className="max-w-3xl text-4xl font-black tracking-tight text-foreground sm:text-5xl lg:text-6xl">
                Cadastre sua empresa sem misturar vitrine publica com gestao.
              </h1>
              <p className="max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                A pagina publica de empresas serve para descoberta. A criacao, configuracao e gestao real acontecem na Central empresarial.
              </p>
            </div>
          ...
          <Card className="overflow-hidden rounded-[2rem] border-border/70 bg-card/90 shadow-xl shadow-black/5 backdrop-blur">
            <CardContent className="space-y-5 p-6 sm:p-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-foreground">Como fica a separacao</h2>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  O cliente encontra sua empresa em /empresas. Voce administra tudo em /central.
                </p>
              </div>
              ...
              <div className="grid gap-3 pt-2 sm:grid-cols-2">
                <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
                  ...
                  <p className="mt-3 text-sm font-semibold">Modulo publico</p>
                  <p className="text-xs text-muted-foreground">/empresas</p>
                </div>
                <div className="rounded-2xl border border-border/70 bg-background/70 p-4">
                  <LayoutDashboard className="h-5 w-5 text-primary" />
                  <p className="mt-3 text-sm font-semibold">Gestao real</p>
