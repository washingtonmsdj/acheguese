...
export function ChangePasswordForm({
  ...
  const passwordStrength = getAuthPasswordStrength(newPassword);
  const passwordRequirements = getAuthPasswordRequirementStatus(newPassword);
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="space-y-2">
            ...
            {confirmPassword.length > 0 && (
              <p className={`text-[10px] font-medium ${passwordsMatch ? "text-success" : "text-destructive"}`}>
      ...
      >
        ...
        <Button onClick={onSave} disabled={loading} className="gap-2 min-w-32">
          {loading ? (
