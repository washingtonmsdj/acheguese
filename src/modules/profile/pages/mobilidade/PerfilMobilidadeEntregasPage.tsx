...
export default function PerfilMobilidadeEntregasPage() {
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr,0.9fr]">
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>
              Fluxo oficial de coleta, partida, entrega e comprovante.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>
              Ajustes e atalhos para manter a operacao fluida.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            ...
            <Button variant="outline" className="w-full justify-between" onClick={() => navigate(getProfileMobilitySectionPath("cadastro"))}>
              Revisar cadastro
              <RotateCcw className="h-4 w-4" />
            </Button>
          </CardContent>
      ...
      <Card className="border-border">
        <CardHeader>
          ...
          <CardDescription>
            Marketplace aberto de entregas para o perfil operacional.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
            ...
            availableDeliveries.map((delivery: RideLike) => (
              <div key={delivery.id} className="rounded-2xl border border-border bg-background p-4 space-y-3">
                ...
                <Button
                  ...
                  onClick={() => shell.acceptRide(delivery.id)}
                >
                  Aceitar entrega
                </Button>
              </div>
