    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[0.95fr,1.05fr]">
        <Card className="border-border">
          <CardHeader>
            <CardTitle>Resumo de ganhos por corrida</CardTitle>
            <CardDescription>Ganhos, taxas e consolidado da operacao de motorista.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>Fluxo recente de ganhos em corridas.</CardDescription>
          </CardHeader>
          <CardContent>
