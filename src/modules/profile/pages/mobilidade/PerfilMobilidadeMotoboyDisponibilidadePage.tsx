      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr,0.9fr]">
        <Card className="border-border">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" onClick={() => navigate(getProfileMobilityServicePath("motoboy", "entregas"))}>
                Ver entregas
              </Button>
            </div>
          </CardContent>
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>Leitura rapida da disponibilidade para entregas.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="rounded-2xl border border-border bg-background p-3">
              <p className="text-xs uppercase tracking-wide text-muted-foreground">Perfil</p>
              <p className="mt-1 text-sm font-medium text-foreground">{shell.driverProfileId ? "Perfil de motoboy encontrado" : "Perfil de motoboy ausente"}</p>
            </div>
            <div className="rounded-2xl border border-border bg-background p-3">
            ...
            <div className="rounded-2xl border border-border bg-background p-3">
              ...
              <p className="mt-1 text-sm font-medium text-foreground">Configure corridas apenas na area Motorista.</p>
            </div>
          </CardContent>
        </Card>
      </div>
