...
function buildSectionProps(
  ...
  switch (section) {
    ...
    case "dados-pessoais":
      ...
      } as SectionPropsMap["dados-pessoais"];
    ...
    case "planos":
      return {
        ...
        context: data.context,
        businessModules: data.businessModules,
      } as SectionPropsMap["planos"];

    case "notificacoes":
      return {
        ...baseProps,
        notifications: data.notifications,
      } as SectionPropsMap["notificacoes"];

    case "configuracoes":
      return {
        ...baseProps,
        canManageProfileMembers: data.canManageProfileMembers,
      } as SectionPropsMap["configuracoes"];
