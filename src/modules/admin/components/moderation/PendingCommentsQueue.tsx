...
import { usePendingComments } from "@/core/moderation/hooks/usePendingComments";
    ...
    return (
      <Card>
        <CardContent className="p-12 text-center">
          ...
          <p className="text-destructive">Error load comentários pendentes</p>
        </CardContent>
      </Card>
    );
  }
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Não há comentários aguardando moderação no momento.
            </p>
          </CardContent>
        </Card>
      ) : (
