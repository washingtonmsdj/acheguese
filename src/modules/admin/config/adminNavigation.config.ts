...
export const ADMIN_NAV_SECTIONS: readonly AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "zeladoria", to: "/admin/zeladoria", icon: Home, label: "Zeladoria", section: "comunidade" },
      { id: "mensagens", to: "/admin/mensagens", icon: MessagesSquare, label: "Conversas", section: "comunidade" },
      { id: "gamificacao", to: "/admin/gamificacao", icon: Trophy, label: "Gamificacao", section: "comunidade" },
