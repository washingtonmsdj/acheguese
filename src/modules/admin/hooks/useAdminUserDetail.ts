...
import type { AdminSuspensionHistoryEntry } from "@/core/admin/services/AdminSuspensionHistoryService";
...
export type SuspensionHistory = AdminSuspensionHistoryEntry;
...
export function useAdminUserDetail(
  ...
  const fetchUserDetail = async () => {
    ...
    try {
      ...
      setDriverData(await AdminUserDetailService.loadDriverDetail(profileData.id, profileData.profile_type));
      ...
      const moderationEvents = await AdminUserDetailService.loadDriverModerationEvents(profileId, profileData.profile_type);
      setSuspensionHistory(
        AdminSuspensionHistoryService.build(profileId, profileData, moderationEvents),
      );
    } catch (err) {
