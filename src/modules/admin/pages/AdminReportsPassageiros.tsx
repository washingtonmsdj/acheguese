/**
 * AdminReportsPassageiros - Gestao de Reports de Corridas
 * 
 * SSOT: RideReportsService como fonte unica
 * Funcionalidades:
 * - Listar reports com filtros
 * - Visualizar detalhes
 * - Atualizar status (pending -> under_review -> resolved/dismissed)
 * - Adicionar notas de resolucao
...
const REPORT_TYPE_LABELS: Record<string, string> = {
  ...
  vehicle_condition: "Condicao do Veiculo",
  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Gestao de problemas reportados</p>
      </div>
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <Badge className={STATUS_COLORS[report.status]}>
                          ...
                          {report.status === "under_review" && "Em Analise"}
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          {selectedReport && (
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium">Notas de Resolucao</label>
                <Textarea
                  value={resolutionNotes}
                  onChange={(e) => setResolutionNotes(e.target.value)}
                  placeholder="Adicionar notas de resolucao..."
                  rows={3}
                />
              </div>
