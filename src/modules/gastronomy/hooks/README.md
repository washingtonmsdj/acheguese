...
**Uso**:
```typescript
import { useGastronomyList } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useGastronomyFoodCatalog } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useGastronomyBusinessSort } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useGastronomyDetail } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useMenu } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useMenusByBusiness } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useMenuItem } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useFeaturedItems } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useActivePromotions } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useGastronomyCart } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useGastronomyCheckout } from '@/modules/gastronomy/hooks';
...
**Uso**:
```typescript
import { useDeliveryDestination } from '@/modules/gastronomy/hooks';
