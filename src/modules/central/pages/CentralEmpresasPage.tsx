...
import { BusinessModulesSection } from "@/modules/profile/components/hub/BusinessModulesSection";
 ...
 * Lista empresas do usuário com CTAs para acessar painel, criar nova empresa, etc.
 * Usa services/hooks canônicos já existentes (useProfileHub, BusinessModulesSection).
 */
export default function CentralEmpresasPage() {
  ...
  // Se não tiver empresas, mostrar empty state
          ...
          <CardContent className="space-y-4 p-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Você ainda não possui empresas administradas. Crie sua primeira empresa para começar a usar o dashboard empresarial.
              </p>
            </div>
