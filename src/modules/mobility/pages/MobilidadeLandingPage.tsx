 ...
 * Usa useMobilityUrls para navega��o
 * Atualizada com separa��o motorista x motoboy
 */
...
const steps = [
  {
    icon: MapPin,
    title: "Solicite",
    desc: "Informe origem, destino e hor�rio desejado.",
  },
  {
    icon: Users,
    title: "Conecte",
    desc: "Motoristas vizinhos recebem sua solicita��o.",
  },
  {
    icon: Shield,
    title: "Combine",
    desc: "Acordo direto, sem taxas de intermedi�rio.",
  },
];
...
const benefits = [
  {
    icon: Zap,
    title: "R�pido & Local",
    desc: "Motoristas da sua regi�o, sempre por perto.",
  },
  {
    icon: Star,
    title: "Avalia��es",
    desc: "Ranking comunit�rio com reputa��o real.",
  },
  {
    icon: Clock,
    title: "Agendamento",
    desc: "Programe viagens com anteced�ncia.",
  },
  {
    icon: Package,
    title: "Entregas",
...
const userTypes = [
  ...
  },
  {
    icon: Car,
    title: "Motorista",
    desc: "Fa�a corridas de passageiros e ganhe dinheiro",
    color: "blue",
    route: "driver",
    badge: "Corridas",
  },
  {
    icon: Bike,
    title: "Motoboy",
    desc: "Fa�a entregas r�pidas de pacotes e encomendas",
    color: "orange",
    route: "motoboy",
    badge: "Entregas",
  },
...
export default function MobilidadeLandingPage({ resolved }: MobilidadeLandingPageProps) {
  ...
  // ? SSOT: Nome do territ�rio
  const territoryName = useMemo(() => {
    return territoryLabels.name || "sua regi�o";
  }, [territoryLabels]);
  ...
  return (
    <div className="w-full min-h-full bg-background overflow-y-auto">
      ...
      <CanonicalHero
        ...
        territoryFallback="Sua Regi�o"
        title={`${territoryName}`}
        titleHighlight="em movimento"
        subtitle="Caronas e entregas entre vizinhos. R�pido, local e sem taxas de aplicativo."
        primaryCTA={{
          label: "Pedir Viagem",
          icon: MapPin,
      ...
      <section className="w-full px-4 pb-12">
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted-foreground mb-6 max-w-md mx-auto">
            Junte-se aos vizinhos que j� economizam tempo e dinheiro com a
            mobilidade comunit�ria.
          </p>
