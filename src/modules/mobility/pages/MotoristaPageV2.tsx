/**
 * Painel do Motorista V2 — Estrutura Profissional AAA
 * Layout otimizado sem gambiarras, seguindo padrões de design system
 */
...
type MotoristaHook = ReturnType<typeof useMotoristaPageV2>;
...
export default function MotoristaPageV2() {
  ...
  // V2: Mostrar loading enquanto verifica se é motorista
  if (hook.loading || !hook.isDriver) {
    return (
  ...
  return (
    <ErrorBoundary onReset={() => window.location.reload()}>
      {/* Layout simples - sem h-screen pois o Layout global já gerencia */}
