/**
 * ClassificadosPage - PÃ¡gina pÃºblica de classificados (REFATORADA)
 * 
...
import { useClassificadosPage } from "@/core/classifieds/hooks/useClassificadosPage";
...
export default function ClassificadosPage({
  ...
  // Extrair nome do territÃ³rio
  const territoryName = useMemo(() => {
    if (!resolved) return "Sua RegiÃ£o";
    const name =
