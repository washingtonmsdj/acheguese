/**
 * Hook para listar vendedores com anÃºncios ativos
 */
...
const MOCK_VENDEDORES: VendedorWithAds[] = [
  {
    ...
    featured_ads: [
      ...
      { id: "ad-1c", title: "AirPods Pro 2Âª GeraÃ§Ã£o", price: 1200, photos: ["https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?w=400&h=300&fit=crop"] },
    ],
  },
  {
    id: "mock-seller-2",
    ...
    active_ads_count: 3,
    featured_ads: [
      { id: "ad-2a", title: "SofÃ¡ 3 Lugares RetrÃ¡til", price: 1200, photos: ["https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=400&h=300&fit=crop"] },
  ...
  },
  {
    ...
    featured_ads: [
      ...
      { id: "ad-3c", title: "Teclado MecÃ¢nico RGB", price: 350, photos: ["https://images.unsplash.com/photo-1618384887929-16ec33fab9ef?w=400&h=300&fit=crop"] },
    ],
  },
  {
    id: "mock-seller-4",
