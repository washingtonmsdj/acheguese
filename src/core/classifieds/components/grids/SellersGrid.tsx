 ...
 * 
 * SSOT: Componente reutilizÃ¡vel de grid de vendedores
...
import { VendedorCard } from "@/core/classifieds/components/VendedorCard";
    ...
    return (
      ...
      >
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Nenhum vendedor ativo nesta regiÃ£o
        </p>
      </motion.div>
    );
  }
