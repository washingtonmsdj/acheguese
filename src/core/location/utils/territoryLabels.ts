  ...
  switch (level) {
    ...
    case 'city':
      return {
        ...
        businessLabel: `Comercios de ${name}`,
        exploreCta: 'Explore comunidades da cidade',
    ...
    case 'group':
      return {
        ...
        inTerritory: `no ${name}`,
        ofTerritory: `do ${name}`,
        mapLabel: 'Mapa da comunidade',
        businessLabel: `Comercios do ${name}`,
        exploreCta: 'Explore a comunidade',
        searchPlaceholder: `Buscar comercios no ${name}...`,
        nearbyLabel: 'Perto de mim',
        emptyContext: 'nesta região',
        allResultsLabel: `Você viu todos os comercios do ${name}`,
