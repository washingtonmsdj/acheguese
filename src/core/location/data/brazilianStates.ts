 ...
 * Usado pelo TerritorySelectorV2 para navegação UF → Cidade.
 */
...
/**
 * Bairros de Salvador — SSOT territorial (cidade de lançamento)
 * Fonte única para qualquer componente que precise listar bairros de Salvador.
 */
export const SALVADOR_NEIGHBORHOODS = [
  'Amaralina', 'Barra', 'Barris', 'Boa Viagem', 'Boca do Rio',
  'Brotas', 'Cabula', 'Cajazeiras', 'Caminho das Árvores', 'Campo Grande',
  'Canela', 'Castelo Branco', 'Centro', 'Cidade Nova', 'Cosme de Farias',
  'Costa Azul', 'Federação', 'Garcia', 'Graça', 'Imbuí',
  'Itaigara', 'Itapuã', 'Liberdade', 'Matatu', 'Mussurunga',
  'Narandiba', 'Nordeste de Amaralina', 'Ondina', 'Paralela', 'Paripe',
  'Pernambués', 'Piatã', 'Pituba', 'Plataforma', 'Ribeira',
  'Rio Vermelho', 'Roma', 'Santa Cruz', 'Santo Antônio', 'São Marcos',
  'STIEP', 'Stella Maris', 'Sussuarana', 'Tancredo Neves',
  'Trobogy', 'Uruguai', 'Vale das Pedrinhas', 'Valéria', 'Vitória',
] as const;
