...
const typeConfig: Record<string, { icon: string; color: string; bg: string }> =
  {
    ride_request: { icon: "CAR", color: "text-teal-400", bg: "bg-teal-500/10" },
    ride_accepted: {
      icon: "OK",
    ...
    post_like: { icon: "LIKE", color: "text-pink-400", bg: "bg-pink-500/10" },
    post_comment: { icon: "MSG", color: "text-blue-400", bg: "bg-blue-500/10" },
    mention: { icon: "@", color: "text-purple-400", bg: "bg-purple-500/10" },
    follow: { icon: "USER", color: "text-indigo-400", bg: "bg-indigo-500/10" },
    badge_earned: {
      icon: "BADGE",
      color: "text-amber-400",
      bg: "bg-amber-500/10",
    },
    level_up: { icon: "UP", color: "text-purple-400", bg: "bg-purple-500/10" },
    system_alert: {
      icon: "WARN",
      color: "text-amber-400",
      bg: "bg-amber-500/10",
    },
    promotion: { icon: "GIFT", color: "text-pink-400", bg: "bg-pink-500/10" },
    default: { icon: "BELL", color: "text-gray-400", bg: "bg-gray-500/10" },
  };
