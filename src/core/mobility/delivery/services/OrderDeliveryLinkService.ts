/**
 * Links canonical orders with ride_requests tracking.
 *
 * SSOT:
 * - orders table: order truth source
 * - ride_requests table: GPS tracking truth source
 * - link: ride_requests.source_type = "gastronomy" + source_id = order.id
 */
