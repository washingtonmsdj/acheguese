/**
 * Fachada canonica de mobilidade para consumo cross-domain.
 *
 * SSOT: exporta queries, mutations e services especializados.
 */
...
export type { RideReport, ReportStatus, ReportSeverity } from "@/core/mobility/services/RideReportsService";
...
export type { BoardingPointSummary, BoardingPointSuggestionInput } from "@/core/mobility/services/BoardingPointService";
...
export { MobilityFacade } from "@/core/mobility/services/MobilityService";
