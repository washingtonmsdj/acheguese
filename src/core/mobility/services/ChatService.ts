/**
 * Mobility chat canonical API.
 *
 * Query/mutation persistence stays split by responsibility; the service class
 * lives in this public owner instead of a parallel `.impl` file.
 */
