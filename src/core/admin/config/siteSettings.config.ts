...
/**
 * Client hints for the canonical MediaAsset broker.
 */
export const SITE_SETTINGS_STORAGE = {
  ...
  RECOMMENDED_SIZES: {
    LOGO_DESKTOP: {
      ...
      height: 48,
      description:
        "Logo horizontal para desktop (topbar altura 64px) - Alta resolução",
    },
    LOGO_MOBILE: {
      width: 48,
      height: 48,
    ...
    FAVICON: {
      ...
      height: 64,
      description:
        "Favicon para navegador - Alta resolução (será redimensionado automaticamente)",
    },
  },
} as const;
