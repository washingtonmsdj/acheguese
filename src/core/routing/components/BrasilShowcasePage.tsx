/**
 * BrasilShowcasePage — Vitrine pública nacional da plataforma
 *
 * Página territorial de nível país. Estilo editorial rico como /cidade.
 * Mostra dados sobre o Brasil, estados, pontos turísticos, estatísticas,
 * cobertura territorial ativa, representantes, contatos úteis.
 *
 * Rota: /brasil
 */
...
const NAV_LINKS = [
  { label: 'Início',       path: 'home' }, // Especial - usa homeUrl
