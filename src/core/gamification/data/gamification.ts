...
export const badges: GamBadge[] = [
  ...
  },
  {
    ...
    name: "Avaliador",
    icone: "⭐",
    description: "Avaliou 5 comércios do neighborhood",
...
export const niveis = [
  ...
  { nivel: 5, name: "Lenda do Complexo", minPontos: 1000, maxPontos: 9999 },
];

export const pontosRegras = [
  { acao: "Publicar post", pontos: 10, icone: "✍️" },
  { acao: "Comentar em post", pontos: 5, icone: "💬" },
  { acao: "Avaliar comércio", pontos: 15, icone: "⭐" },
  { acao: "Confirmar presença em evento", pontos: 10, icone: "📅" },
  { acao: "Publicar classificado", pontos: 10, icone: "🏷️" },
  { acao: "Receber curtida", pontos: 2, icone: "❤️" },
  { acao: "Copiar cupom", pontos: 3, icone: "🎟️" },
];
