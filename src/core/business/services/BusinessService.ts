...
export {
  ...
  getBusinessBySlug,
  checkBusinessSlugExists,
  getBusinessSimilarSlugs,
  getBusinessesByIds,
...
export class BusinessService {
  ...
  static checkSlugExists = BusinessQueries.checkBusinessSlugExists;
  static getSimilarSlugs = BusinessQueries.getBusinessSimilarSlugs;
