...
| **CommunityService** | `recordInteraction` | `userId` | `UserId` | community_interactions.user_id |
| **CommunityService** | `joinGroup`, `leaveGroup` | `userId` | `UserId` | group_members.user_id |
| **ModerationService** | `reportContent` | `reporterId` | `ProfileId` | Contexto social do denunciante |
...
1. **Lote 1** — Hooks core: `useProfile`, `useActiveProfile`, `useCommunityProfile`
