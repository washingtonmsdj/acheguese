 ...
 * 
 * @example
 * import { getCountryData, getActiveStates, getPlatformStats } from '@/core/landing/services/LandingService';
 * import type { CountryData, StateData, PlatformStats } from '@/core/landing/services/LandingService';
 */
