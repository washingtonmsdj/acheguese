/**
 * ServicosLandingPage â€” Vitrine pÃºblica de serviÃ§os
 * Estilo editorial: dark theme, acentos teal, motion.
 *
 * âœ… SSOT compliant:
 * - Recebe resolved + activeMemberIds (padrÃ£o modular)
 * - useServicos com filtro territorial
 * - useServiceUrls para navegaÃ§Ã£o
...
import { useServicos } from "@/core/services/hooks/useServicos";
import { useTopRatedProfessionals } from "@/core/services/hooks/useTopRatedProfessionals";
import {
  SERVICE_CATEGORY_OPTIONS,
  getServiceCategoryIcon,
  getServiceCategoryLabel,
} from "@/core/services/domain/professionalCategories";
...
// â”€â”€ Dados estÃ¡ticos â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

const STATS = [
  { icon: Users,  value: "250+",  label: "profissionais",      color: "text-primary" },
  { icon: Star,   value: "4.8",   label: "avaliaÃ§Ã£o mÃ©dia",    color: "text-warning" },
  { icon: Shield, value: "100%",  label: "verificados",        color: "text-success" },
  { icon: Clock,  value: "< 2h",  label: "tempo de resposta",  color: "text-accent"  },
];

const HOW_IT_WORKS = [
  { step: "01", icon: Search, title: "Busque o serviÃ§o",    description: "Encontre o profissional ideal filtrando por categoria, avaliaÃ§Ã£o ou proximidade." },
  { step: "02", icon: Phone,  title: "Entre em contato",    description: "Fale diretamente via WhatsApp ou chat. Sem intermediÃ¡rios, sem taxas." },
  { step: "03", icon: Star,   title: "Avalie o serviÃ§o",    description: "ApÃ³s concluir, avalie o profissional para ajudar outros moradores." },
];

const BENEFITS = [
  { icon: BadgeCheck, title: "Profissionais Verificados", description: "Todos os prestadores passam por verificaÃ§Ã£o de identidade e histÃ³rico.",                                    color: "text-primary", bgColor: "bg-primary/10" },
  { icon: MapPin,     title: "Perto de VocÃª",             description: "Profissionais da sua regiÃ£o, com menor tempo de deslocamento e maior compromisso.",                        color: "text-accent",  bgColor: "bg-accent/10"  },
  { icon: Shield,     title: "Garantia ComunitÃ¡ria",      description: "AvaliaÃ§Ãµes reais de moradores como vocÃª. TransparÃªncia total.",                                            color: "text-success", bgColor: "bg-success/10" },
  { icon: Zap,        title: "Resposta RÃ¡pida",           description: "Os profissionais se comprometem a responder em atÃ© 2 horas durante o horÃ¡rio comercial.",                  color: "text-warning", bgColor: "bg-warning/10" },
];

// â”€â”€ Componentes auxiliares â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {pro.totalAvaliacoes > 0 && <p className="text-[11px] text-muted-foreground mt-2">{pro.totalAvaliacoes} avaliaÃ§Ãµes</p>}
      </div>
    </motion.div>
  );
}
...
// â”€â”€ PÃ¡gina principal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function ServicosLandingPage({ resolved, activeMemberIds }: ServicosLandingPageProps) {
  ...
  // âœ… SSOT: Nome do territÃ³rio com preposiÃ§Ã£o
  const territoryName = useMemo(() => {
    return territoryLabels.inTerritory || "perto de vocÃª";
  }, [territoryLabels]);
  ...
  // âœ… SSOT global para todas as URLs â€” inclui services, business, classifieds, community
  const appUrls = useAppUrls(resolved);

  // âœ… SSOT: useServicos com filtro territorial â€” respeita resolved + activeMemberIds
  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground flex flex-col">
      ...
      {/* â”€â”€ BANNER PROMOCIONAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-center gap-2 text-sm">
          ...
          <span className="text-muted-foreground">
            <span className="font-semibold text-foreground">Cadastre-se grÃ¡tis!</span>{" "}
            OfereÃ§a seus serviÃ§os para milhares de moradores na sua regiÃ£o.
          </span>
          <button onClick={() => navigate(appUrls.services.register)}
            ...
            ComeÃ§ar <ArrowRight className="h-3 w-3" />
          </button>
        </div>
      </motion.div>
      ...
      <CanonicalHero
        moduleName="ServiÃ§os"
        moduleIcon={Wrench}
        territoryName={territoryName?.replace(/^n[oa]\s/, '')}
        territoryFallback="Sua RegiÃ£o"
      ...
      {/* â”€â”€ ESTATÃSTICAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ TOP RATED â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {topRated.length > 0 && (
      ...
      {/* â”€â”€ CATEGORIAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-10 md:pb-14 w-full">
        <div className="bg-secondary/50 border border-border rounded-2xl p-5 md:p-8">
          <div className="flex items-center justify-between mb-5">
            <div>
              <h2 className="text-xl font-bold text-foreground font-heading">Categorias de ServiÃ§os</h2>
              <p className="text-sm text-muted-foreground mt-1">Encontre exatamente o que vocÃª precisa</p>
            </div>
      ...
      {/* â”€â”€ PROFISSIONAIS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-10 md:pb-14 w-full">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl md:text-2xl font-bold text-foreground font-heading">
              {selectedCategory === "todos" ? "Profissionais DisponÃ­veis" : getServiceCategoryLabel(selectedCategory) || "Profissionais"}
            </h2>
      ...
      {/* â”€â”€ COMO FUNCIONA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-muted-foreground mt-2 max-w-md mx-auto">
              Simples, rÃ¡pido e sem burocracia. Conecte-se diretamente com profissionais da sua regiÃ£o.
            </p>
          </div>
      ...
      {/* â”€â”€ BENEFÃCIOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16 w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-2 max-w-md mx-auto">
            Vantagens exclusivas para quem busca e oferece serviÃ§os na comunidade.
          </p>
        </div>
      ...
      {/* â”€â”€ CTA CADASTRO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="relative p-6 md:p-10 flex flex-col md:flex-row items-center gap-6">
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-xl md:text-2xl font-bold text-foreground mb-2 font-heading">Ã‰ Profissional? Cadastre-se GrÃ¡tis!</h2>
              <p className="text-muted-foreground text-sm md:text-base mb-4 max-w-lg">
                Aumente sua visibilidade, receba avaliaÃ§Ãµes dos moradores e conquiste novos clientes na sua regiÃ£o. Sem taxas, sem intermediÃ¡rios.
              </p>
              <div className="flex items-center gap-4 justify-center md:justify-start text-xs text-muted-foreground">
                ...
                <span className="flex items-center gap-1"><Heart className="h-3.5 w-3.5 text-accent" /> AvaliaÃ§Ãµes reais</span>
      ...
      <section className="w-full bg-gradient-to-br from-primary/20 via-card to-accent/20 border-t border-border">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 md:py-16 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3 font-heading">Precisa de um ServiÃ§o?</h2>
          <p className="text-muted-foreground text-sm md:text-base mb-6 max-w-lg mx-auto">
            Encontre profissionais avaliados pela comunidade. RÃ¡pido, confiÃ¡vel e perto de vocÃª.
          </p>
          <Button onClick={() => navigate(appUrls.services.list)}
