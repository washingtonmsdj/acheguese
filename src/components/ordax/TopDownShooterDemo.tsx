...
import type { GameState } from "@/lib/ordax/systems/GameStateSystem";
import { Button } from "@/components/ui/button";

// Minimal types for demo runtime
interface DemoSystems {
  gameState: { current: GameState };
  juice: { render: (ctx: CanvasRenderingContext2D, entities: OrdaxEntity[]) => void };
  ui: {
    render: (
...
export function TopDownShooterDemo() {
  ...
  const systemsRef = useRef<DemoSystems | null>(null);
