  ...
  public: {
    Tables: {
      ...
      event_saved_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_saved_items_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "event_saved_items_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "personal_social_profiles"
            referencedColumns: ["profile_id"]
    ...
    Functions: {
      ...
      territorial_admin_save_group: {
        Args: {
          p_anchor_city_id: string
          p_description: string
          p_group_id: string
          p_member_location_ids: string[]
          p_name: string
          p_slug: string
        }
        Returns: Json
      ...
      territorial_admin_set_group_status: {
        Args: { p_group_id: string; p_status: string }
        Returns: Json
      }
