 ...
 *
 * Keep this module runtime-neutral: no browser, Node, Deno, Supabase or app
 * imports. Edge Functions import it by relative path and the app consumes the
 * same object through MobilityDispatchConfigService.
 */
