/**
 * @deprecated Use UISystem from UISystem-refactored.ts instead
 * 
 * This is the legacy UISystem implementation.
 * The refactored version provides:
 * - Better type safety
 * - Performance optimizations (caching, dirty checking)
 * - More features (object pooling, batch rendering)
 * - Cleaner architecture
 * 
 * Migration: Import from UISystem-refactored.ts
 * ```typescript
...
export class UISystem {
  ...
  render(ctx: CanvasRenderingContext2D, gameState?: string, entities?: Record<string, unknown>[], scoreSystem?: Record<string, unknown>, timerSystem?: Record<string, unknown>) {
  ...
  private renderStartScreen(ctx: CanvasRenderingContext2D, config?: Record<string, unknown>) {
  ...
  private renderHUD(ctx: CanvasRenderingContext2D, entities: Record<string, unknown>[], config?: Record<string, unknown>, scoreSystem?: Record<string, unknown>, timerSystem?: Record<string, unknown>) {
  ...
  private renderGameOverScreen(ctx: CanvasRenderingContext2D, config?: Record<string, unknown>, scoreSystem?: Record<string, unknown>, timerSystem?: Record<string, unknown>) {
    ctx.fillStyle = "rgba(0, 0, 0, 0.8)";
    ctx.fillRect(0, 0, ctx.canvas.width, ctx.canvas.height);
