...
- Name: central\central-validation.spec.ts >> Central - Redirects Legados >> should redirect /perfil/mobilidade/motorista/corridas to /central/motorista/corridas
- Location: tests\e2e\central\central-validation.spec.ts:80:3
...
Expected substring: "/central/motorista/corridas"
Received string:    "http://localhost:8080/perfil/mobilidade/motorista/corridas"
```
