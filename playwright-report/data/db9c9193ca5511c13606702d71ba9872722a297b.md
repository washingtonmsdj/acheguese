...
- Name: central\central-validation.spec.ts >> Central - Redirects Legados >> should redirect /perfil/mobilidade/motoboy to /central/motoboy
- Location: tests\e2e\central\central-validation.spec.ts:90:3
...
Expected substring: "/central/motoboy"
Received string:    "http://localhost:8080/perfil/mobilidade/motoboy"
```
