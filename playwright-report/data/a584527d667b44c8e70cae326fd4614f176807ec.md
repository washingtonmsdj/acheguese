...
- Name: central\central-validation.spec.ts >> Central - Redirects Legados >> should redirect /perfil/mobilidade/motorista to /central/motorista
- Location: tests\e2e\central\central-validation.spec.ts:70:3
...
Expected substring: "/central/motorista"
Received string:    "http://localhost:8080/perfil/mobilidade/motorista"
```
