...
Objetivo: ser o índice oficial da documentação viva do projeto. Histórico de marcos e freezes permanece no Git ou em `docs/10-archive/`, sem competir com os owners atuais.

Regra: qualquer documento fora deste indice nao deve ser tratado como fonte normativa sem verificar seu status aqui. Documentos substituidos nao permanecem como tombstones na arvore ativa; o historico fica no Git e em docs/10-archive quando houver valor historico.
...
| docs/10-archive/product/DEMO-READY.md                                                        | Product              | HISTORICO   | Product              | docs/FEATURE-MAP.md                                      | Relatorio de demo preservado como historico.                                         |
| docs/10-archive/product/PROJECT-HEALTH-REPORT.md                                             | Product              | HISTORICO   | Product              | docs/FEATURE-MAP.md                                      | Relatorio de saude preservado como historico.                                        |
| docs/10-archive/product/PROJECT-SCORE.md                                                     | Product              | HISTORICO   | Product              | docs/FEATURE-MAP.md                                      | Score preservado como historico.                                                     |
...
| docs/architecture/core-platform-ownership.json                                       | Architecture         | CANONICO    | Architecture         | docs/03-architecture/CORE_PLATFORM_ARCHITECTURE_SSOT.md  | Manifesto executavel de ownership e callsites do Core Platform.                      |
| docs/audits/architecture-boundaries-incremental-baseline.json                        | Architecture         | CANONICO    | Architecture         | tools/architecture/validate-architecture-boundaries-incremental.mjs | Baseline executavel vazio; novas violacoes de boundary permanecem bloqueantes.       |
...
| ---------------------------------------------- | ---------: | --------- |
| docs/10-archive/architecture-legacy/\*\*       |         23 | ARQUIVADO |
| docs/10-archive/audits/\*\*                    |         48 | ARQUIVADO |
...
Total em `docs/10-archive/**`: 142 documentos.
