...
Itens, categorias, edição e disponibilidade. Conferir regras de adicionais, preços, estoque e horários no código.

## Referências visuais

- [017-gestao-cardapio](pranchas/017-gestao-cardapio.png) — Referência para revisão.
