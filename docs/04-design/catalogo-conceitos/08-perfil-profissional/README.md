...
Apresentação, serviços, trabalhos e recomendações. Permissões, avaliações e contatos dependem de contratos reais.

## Referências visuais

- [010-perfil-profissional](pranchas/010-perfil-profissional.png) — Referência para revisão.
