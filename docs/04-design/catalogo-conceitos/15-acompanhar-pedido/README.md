...
Preparo, trajeto, sinal desatualizado e conclusão. Mostrar última atualização e mapa apenas quando rastreamento autorizado existir.

## Referências visuais

- [022-acompanhamento-inicial](historico/022-acompanhamento-inicial.png) — Histórico — não aplicar automaticamente.
- [023-acompanhamento-mobile](pranchas/023-acompanhamento-mobile.png) — Referência para revisão.
- [025-acompanhamento-desktop](pranchas/025-acompanhamento-desktop.png) — Referência para revisão.
