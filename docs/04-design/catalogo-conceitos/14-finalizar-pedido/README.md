...
- [020-checkout-inicial](historico/020-checkout-inicial.png) — Histórico — não aplicar automaticamente.
- [021-checkout-plataforma](pranchas/021-checkout-plataforma.png) — Referência para revisão.
- [024-checkout-mobile-estados](pranchas/024-checkout-mobile-estados.png) — Referência para revisão.
