...
Fila de atendimento, filtros e estados. Evitar comandos que avancem indevidamente o pedido ou confirmem pagamento sem evidência.

## Referências visuais

- [026-pedidos-loja](pranchas/026-pedidos-loja.png) — Referência para revisão.
