# Expansão e interesse em outras comunidades

## Escopo

Indicar região, confirmar interesse, optar por novidades e criar conta. Interesse não significa comunidade ativada, vínculo aprovado nem promessa de data.

## Referências visuais

- [054-encontrar-comunidade](historico/054-encontrar-comunidade.png) — Histórico — não aplicar automaticamente.
- [060-expansao-interesse](pranchas/060-expansao-interesse.png) — Referência para revisão.
