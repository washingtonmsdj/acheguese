...
Criar, alternar, editar e gerenciar perfis pessoais e de negócio. Conta, perfil e vínculo são entidades distintas.

## Referências visuais

- [013-conta-perfis-inicial](historico/013-conta-perfis-inicial.png) — Histórico — não aplicar automaticamente.
- [015-meus-perfis](pranchas/015-meus-perfis.png) — Referência para revisão.
