...
- [041-ganhos-mobile-inicial](historico/041-ganhos-mobile-inicial.png) — Histórico — não aplicar automaticamente.
- [042-ganhos-mobile](pranchas/042-ganhos-mobile.png) — Referência para revisão.
- [043-recebimentos-inicial](historico/043-recebimentos-inicial.png) — Histórico — não aplicar automaticamente.
- [044-recebimentos-estados](pranchas/044-recebimentos-estados.png) — Referência para revisão.
- [045-ganhos-desktop](pranchas/045-ganhos-desktop.png) — Referência para revisão.

## Conferência no projeto

Localizar rotas, componentes, serviços e contratos desta página antes de implementar. A organização não certifica que todas as funcionalidades da imagem existem.
