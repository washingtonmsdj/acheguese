...
Logo, símbolo, cores e tipografia. A alternativa de símbolo não constitui aprovação de marca. Usar SSOT vigente; não extrair tokens de pixels.

## Referências visuais

- [004-identidade-simbolo](historico/004-identidade-simbolo.png) — Histórico — não aplicar automaticamente.
- [005-logo-alternativa](pranchas/005-logo-alternativa.png) — Referência para revisão.
