...
Receber, preparar, cancelar e concluir. Separar estado financeiro, cozinha e entrega; validar cada transição.

## Referências visuais

- [027-atendimento-mobile](pranchas/027-atendimento-mobile.png) — Referência para revisão.
- [029-atendimento-desktop](pranchas/029-atendimento-desktop.png) — Referência para revisão.
