# Cardápio público e seleção de itens

## Escopo

Loja, busca, categorias, produto e adicionais. Preços e carrinho devem derivar do contrato, sem valores estáticos.

## Referências visuais

- [018-cardapio-publico](historico/018-cardapio-publico.png) — Histórico — não aplicar automaticamente.
- [019-cardapio-produto](pranchas/019-cardapio-produto.png) — Referência para revisão.
