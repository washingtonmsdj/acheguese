...
- **Setup Page:** `src/modules/gastronomy/pages/GastronomySetupPage.tsx`
- **Widget:** `src/modules/gastronomy/components/GastronomyVerticalStatus.tsx`
- **Queries:** `src/modules/gastronomy/services/gastronomy.queries.ts`
