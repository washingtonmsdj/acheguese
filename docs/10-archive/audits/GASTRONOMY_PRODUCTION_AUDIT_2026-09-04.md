> Arquivado em 2026-09-18. Este documento preserva um snapshot histórico de hardening e não é documentação operacional atual. O contrato ativo do módulo está em `src/modules/business/gastronomy/README.md`.
