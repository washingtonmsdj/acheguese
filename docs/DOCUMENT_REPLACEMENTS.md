...
| --- | --- | --- | --- |
| Relatorios de sessao, gate, etapa, entrega e status | `docs/archive/root-legacy/`, `docs/archive/status/`, `docs/historico/`, `docs/STATUS.md`, `docs/VALIDACAO_FINAL_E_PROXIMOS_PASSOS.md` | `docs/STATUS_ATUAL.md` + `docs/ACAO_EXECUTAVEL_AUDITORIA_HIPERLOCAL.md` | Historico continua arquivado; nao e fonte de regra atual. |
...
| Mapas canonicos e indices sobrepostos | versoes antigas de `README.md`, `DOCUMENTATION_INDEX.md`, `STATUS.md` e `CANONICAL_MAP.md` | `docs/INDEX_CANONICO.md` + `docs/STATUS_ATUAL.md` + `docs/CANONICAL_MAP.md` | `README.md` voltou a ser apenas a porta de entrada. |
