...
- [x] P0: revisar `docs/STATUS.md`. Ele agora e redirecionamento legado para `docs/STATUS_ATUAL.md`.
- [x] P0: revisar `docs/VALIDACAO_FINAL_E_PROXIMOS_PASSOS.md`. Ele agora e redirecionamento legado e nao declara prontidao.
