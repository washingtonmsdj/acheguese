...
| `community-alerts` | sim | sim | alertas e issues administrativos | ownership documental unico e integracao com civic reports | `modules/community-alerts` + `core/community/alerts`, `core/community-issues` | high | documentar |
