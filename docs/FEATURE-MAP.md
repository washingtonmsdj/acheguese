...
| Funcionalidade | Status | Rota |
|---|---|---|
| Perfil (multi-perfis, hub responsivo) | ✅ | `/perfil`, `/perfil/*` |
| Editar perfil (com `profileId`) | ✅ | `/perfil/editar`, `/perfil/editar/:profileId` |
| Configurações / privacidade / notificações | ✅ | `/perfil/configuracoes`, `/perfil/preferencias`, `/perfil/enderecos`, `/perfil/notificacoes` |
| Área "Conta" (aliases legados) | ✅ | `/conta/*` (mesmos alvos) |
