...
- Validadores genéricos estavam isolados em `src/modules/business/gastronomy/services/validators.ts`
...
- `src/modules/business/gastronomy/services/GastronomyQueryService.ts` (import atualizado)
- `src/modules/business/gastronomy/services/MenuQueryService.ts` (import atualizado)
...
**Localização:** `src/modules/business/gastronomy/components/GastronomyFilters.tsx`
