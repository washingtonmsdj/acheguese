# APLICAR MOTOR OPERACIONAL - MANUAL

## PROBLEMA
O SQL não pode ser aplicado via código. Deve ser aplicado manualmente via Supabase Dashboard.
...
### 4. Executar (Run)
- Clicar no botão "Run" ou Ctrl+Enter
- Aguardar conclusão

### 5. Verificar resultado
Deve aparecer: `✅ Motor operacional criado!`

## VALIDAÇÃO

Após aplicar, executar:
```bash
node testar_motor_operacional.mjs
```
