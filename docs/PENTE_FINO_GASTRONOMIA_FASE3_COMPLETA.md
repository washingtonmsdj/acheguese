...
**Localização do Hook:**
```typescript
// src/modules/gastronomy/hooks/useDeliveryDestination.ts
// JÁ IMPLEMENTADO!
```
...
**Correção:**
Mover para `src/modules/gastronomy/constants/landing.ts`
...
**Correção:**
Mover para `src/modules/gastronomy/utils/deliveryDestination.ts` (já existe!)
