...
- Busca é capability horizontal. `searchProviderScope.ts` deriva os buckets autorizados pelo lifecycle e `SearchService` recebe esse scope explicitamente; sem buckets, falha fechado. No corte atual, somente Business participa.
