...
describe('Integração - Módulo de Mobilidade', () => {
  describe('Estrutura de Arquivos', () => {
    it('deve ter MotoboyAuthorizationService exportado', async () => {
      const module = await import('@/core/mobility/services/MotoboyAuthorizationService');
    ...
    it('deve ter RideReportsService exportado', async () => {
      const module = await import('@/core/mobility/services/RideReportsService');
    ...
    it('deve ter RideOperationalService exportado', async () => {
      const module = await import('@/core/mobility/core/RideOperationalService');
  ...
  describe('Constantes', () => {
    it('deve ter query keys centralizadas', async () => {
      const { MOBILITY_QUERY_KEYS } = await import('@/core/mobility/constants');
  ...
  describe('Componentes Admin', () => {
    it('deve ter AdminMotoboyOperations definido', async () => {
      const module = await import('@/modules/admin/pages/AdminMotoboyOperations');
      expect(module.default).toBeDefined();
    });

    it('deve ter AdminReportsPassageiros definido', async () => {
      const module = await import('@/modules/admin/pages/AdminReportsPassageiros');
      expect(module.default).toBeDefined();
    });
  });
  ...
  describe('Hooks', () => {
    it('deve ter useDelivery exportado', async () => {
      const module = await import('@/modules/mobility/hooks/useDelivery');
      expect(module.useDelivery).toBeDefined();
    });

    it('deve ter useMobilidade exportado', async () => {
      const module = await import('@/modules/mobility/hooks/useMobilidade');
  ...
  describe('Páginas', () => {
    it('deve ter PassageiroPage definida', async () => {
      const module = await import('@/modules/mobility/pages/PassageiroPage');
      expect(module.default).toBeDefined();
    });

    it('deve ter HistoricoPage definida', async () => {
      const module = await import('@/modules/mobility/pages/HistoricoPage');
      expect(module.default).toBeDefined();
    });

    it('deve ter MotoboyPage definida', async () => {
      const module = await import('@/modules/mobility/pages/MotoboyPage');
      expect(module.default).toBeDefined();
    });

    it('deve ter TrackRidePage definida', async () => {
      const module = await import('@/modules/mobility/pages/TrackRidePage');
      expect(module.default).toBeDefined();
    });
  });
  ...
  describe('Validação de Imports', () => {
    it('não deve ter imports circulares críticos', async () => {
      ...
      const imports = await Promise.all([
        import('@/core/mobility/services/MotoboyAuthorizationService'),
        import('@/core/mobility/services/RideReportsService'),
        import('@/core/mobility/core/RideOperationalService'),
        import('@/modules/mobility/hooks/useDelivery'),
        import('@/modules/mobility/hooks/useMobilidade'),
      ]);
  ...
  describe('Autorização Centralizada', () => {
    it('deve ter autorização no backend', async () => {
      const { MotoboyAuthorizationService } = await import(
        '@/core/mobility/services/MotoboyAuthorizationService'
      );
...
describe('Validação de Qualidade', () => {
  describe('TypeScript', () => {
    ...
    it('deve ter tipagem forte em hooks', async () => {
      const { useDelivery } = await import('@/modules/mobility/hooks/useDelivery');
