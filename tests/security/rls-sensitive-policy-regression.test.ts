...
const BASELINE = "20260825172854_remove_legacy_ad_public_select_shadow.sql";
...
describe("sensitive RLS policy regression guard", () => {
  it("keeps the moderation blocklist unreadable to anonymous clients", () => {
    ...
    expect(migration).not.toContain("GRANT SELECT ON TABLE public.issue_blocked_terms TO anon");
  });
