...
test.describe('Mobile territorial public surfaces', () => {
  test('cidade /ba/salvador em 360px', async ({ page }) => {
    await expectMobilePublicSurface(page, {
      path: '/ba/salvador',
      expectedUrlPart: '/ba/salvador',
      readyPattern: /salvador em tempo real/i,
    });
  ...
  test('comunidade de bairro em 360px', async ({ page }) => {
    await expectMobilePublicSurface(page, {
      path: '/comunidade/ba/salvador/nordeste-de-amaralina',
      expectedUrlPart: '/comunidade/ba/salvador/nordeste-de-amaralina',
      readyPattern: /nordeste de amaralina/i,
    });
