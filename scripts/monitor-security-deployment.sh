...
#
# Uso:
#   ./scripts/monitor-security-deployment.sh [duration_in_hours]
#
# Exemplos:
#   ./scripts/monitor-security-deployment.sh 2    # Monitorar por 2 horas
#   ./scripts/monitor-security-deployment.sh 24   # Monitorar por 24 horas
###############################################################################
