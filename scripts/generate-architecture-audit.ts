...
function inferDomainFromRoute(route: RouteEntry): string | null {
  ...
  const prefixChecks: Array<[string, string]> = [
    ...
    ["/c/", "classifieds"],
    ["/:communitySlug/empresas", "business"],
    ["/:communitySlug/gastronomia", "gastronomy"],
    ["/:communitySlug/feed", "community-feed"],
    ["/:communitySlug/grupos", "community-groups"],
    ["/:communitySlug/problemas", "community-issues"],
