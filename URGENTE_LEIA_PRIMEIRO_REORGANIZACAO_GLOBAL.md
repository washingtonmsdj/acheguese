...
- o head remoto atual é `7fd8aa36ac68a5d717b843bf82ccb441a33cc02b`, commit de reconciliação nominal de 32 migrations já presentes no ledger Supabase. O Vercel desse SHA também está `READY`, com `Vercel=success` e smoke HTTP 200; os demais jobs hospedados continuam falhando antes de etapas e o sync canônico de tipos permanece `queued`;
