...
- [ ] NEXT_ACTION Events: auditar `event_reminders`, `event_reviews` e `event_review_helpfulness` por caller, grants/RLS e identidade de Profile; corrigir somente bypass/drift comprovado.
