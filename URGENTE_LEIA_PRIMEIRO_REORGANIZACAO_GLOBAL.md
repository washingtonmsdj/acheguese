...
- [ ] NEXT_ACTION Events: auditar mutations de `public.events` (create/update/delete) e identidade do organizador por grants/RLS/guards; corrigir somente bypass comprovado e preservar leitura publica/territorial existente.
