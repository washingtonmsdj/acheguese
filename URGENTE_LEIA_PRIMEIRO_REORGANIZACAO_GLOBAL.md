...
- [ ] NEXT_ACTION sem Vercel: iniciar auditoria da Territory Home/Home Discovery para remover dados editoriais fictícios que se apresentam como atividade atual, preservando bairros/cidades e demais dados públicos reais; qualquer referência a escola/hospital/órgão público deve ser atualizada por fonte oficial, não apagada.
